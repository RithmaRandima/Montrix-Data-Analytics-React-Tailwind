  ...
  return (
    <div className="w-[100%] h-[100%] py-4 bg-[#121212] text-white">
      ...
      <div className="text-center mb-[20px] py-5 ">
        ...
        <h1 className="md:text-4xl sm:text-3xl text-[24px] font-[700] mt-[10px] ">
          Our Valuable Customers
        </h1>
        <p className="text-[13px] mt-[25px] leading-[20px] tracking-[2px]  md:w-[60%] w-[80%] mx-auto  text-gray-500">
