...
function Hero() {
  return (
    <div id="home" className="text-white h-[100vh] w-[100%] relative">
      ...
      <div className="absolute pt-[30px] md:pt-[0] top-0 left-0 bg-gradient-to-t from-black/80 to-black/40  w-[100%] h-[100vh] text-center flex flex-col justify-center">
        <div>
          ...
          <p className="md:text-[16px] text-[16px] mt-4 md:leading-[30px] md:tracking-[2px] w-[80%] md:w-[67%] mx-auto  text-gray-500">
